      ...
      <div className="row">
        ...
        <div className="col-sm-6">
          <div className="row">
            ...
            <div className="col">
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label">Object target</label>
                <Select />
                </div>
                <div>
                <label htmlFor="exampleInputEmail1" className="form-label">JsonPath target</label>
                <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="$.masterAgreementNumber" />
              </div>
            </div>
